...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Alt  | GUI  | GUI  |Space |Space |Space |Raise |Raise |   =  | \    | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
    [_QWERTY] = LAYOUT(
        ...
        ADJUST, KC_LALT, KC_LGUI, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, RAISE, RAISE, KC_EQL, KC_BSLS, KC_DOWN, KC_UP, KC_RGHT),
...
__attribute__((weak)) void led_test_init(void) {}
